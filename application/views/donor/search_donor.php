                                ...
                                try {
                                    ...
                                    $.each(obj, function (i, val) {
                                        ...
                                        if (val.donorStatus == "current") {
                                            donor_data += '<div class="card col-lg-4 col-md-4 col-sm-4 col-xs-12 filter current" id="current" style="height: 100px; border-style: solid;border-left-color: dodgerblue; border-left-width: 3px; pdding:10px; margin-top: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);border-radius: 5px; transition: 0.3s;">\n' +
                                                '                            \n' +
                                                '                        <div class="form-inline">\n' +
                                                '                            <div class="col-md-3 col-xs-3">\n' +
                                                '                                <label>image</label>\n' +
...
//                                        donor_data += '<td>' + window.j + '</td>';
                                            ...
                                            donor_data += '<div class="card col-lg-4 col-md-4 col-sm-4 col-xs-12 filter approve" id="approve" style="height: 100px;  border-style: solid;border-left-color: green; border-left-width: 3px;pdding:10px; margin-top: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);border-radius: 5px; transition: 0.3s;">\n' +
                                                '                        <div class="form-inline">\n' +
                                                '                            <div class="col-md-3 col-xs-3">\n' +
                                                '                                <label>image</label>\n' +
                                                '                            </div>\n';
//                                        donor_data += '<td>' + window.j + '</td>';
                                            ...
                                            donor_data += '<div class="card col-lg-4 col-md-4 col-sm-4 col-xs-12 filter p_deffer" id="p_differ" style="height: 100px; border-style: solid;border-left-color: darkred; border-left-width: 3px; pdding:10px; margin-top: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);border-radius: 5px; transition: 0.3s;">\n' +
                                                '                        <div class="form-inline">\n' +
                                                '                            <div class="col-md-3 col-xs-3">\n' +
                                                '                                <label>image</label>\n' +
                                                '                            </div>\n';
//                                        donor_data += '<td>' + window.j + '</td>';
                                            ...
                                            donor_data += ' <div class="card col-lg-4 col-md-4 col-sm-4 col-xs-12 filter t_deffer" id="t_differ" style="height: 100px; border-style: solid;border-left-color: #FFD700; border-left-width: 3px; pdding:10px; margin-top: 10px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);border-radius: 5px; transition: 0.3s;">\n' +
                                                '                        <div class="form-inline">\n' +
                                                '                            <div class="col-md-3 col-xs-3">\n' +
                                                '                                <label>image</label>\n' +
                                                '                            </div>\n';
